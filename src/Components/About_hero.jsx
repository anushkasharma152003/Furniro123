  ...
  return (
    <section className="lg:w-screen sm:w-[1024px] md:w-[1124px]  w-[960px]  ">
      <div className="relative">
        <div>
          <img src="/Shophero1.png" alt="" />
        </div>
        <div className="flex justify-center">
          <h1 className="absolute  lg:top-[121px] sm:top-[111px] md:top-[121px] top-[101px] font-medium text-5xl">Blog</h1>
        </div>
        <div className="flex absolute top-[195px] left-[660px]">
          <div>
            <h2 className="font-medium text-base"></h2>
          </div>
          <div>
            {/* <img src="Shop_hero_icon.png" alt="" className="pt-[3px]" /> */}
          </div>
          <div>
            <h2 className="font-light text-base"></h2>
          </div>
        </div>
      </div>
      ...
      <div className="pt-[106px] pl-[97px] pr-[100px]">
        <div className="  flex">
          ...
          <div className="ml-[177px] ">
            <button className="py-[17px] pl-[287px] pr-[17px] -ml-[106px] border-[1px] border-gray-600 rounded-[10px]">
              <img src="/icon3.png" alt="" className="h-[24px] w-[24px]" />
            </button>
            <div className="-ml-[65px]">
              <h1 className="mb-[41px] font-medium text-2xl mt-[43px]">
                Categories
              </h1>

              <div className="flex gap-[185px]">
                <div className="flex flex-col gap-[41px]">
                  <h2 className=" text-[#9F9F9F] text-base font-normal">
                    Crafts
                  </h2>
                  <h2 className=" text-[#9F9F9F] text-base font-normal">
                    Design
            ...
            <div className="mt-[117px] flex flex-col gap-[39px] -ml-[65px]">
              <h1 className="font-medium text-2xl pb-[26px] pt-[16px]">
                Recent Posts
              </h1>
